...
const workoutUpdate = (event, workout) => {
    ...
    fetch(`http://localhost:4050/log/${props.workoutToUpdate.id}`, {
        method: 'PUT',
        ...
        <Modal isOpen={true}>
            ...
            <ModalBody>
                <Form onSubmit={workoutUpdate}>
                    <FormGroup>
                        <Label htmlFor="result">Edit Result:</Label><Input name="result" value={editRes} onChange={(e) => setEditRes(e.target.value)}/>
